    ...
    <div className="new-landing-page">
      <header className="landing-header">
        <nav className="landing-nav">
          <div className="nav-logo">&lt;Trackr/&gt;</div>
